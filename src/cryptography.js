...
class CryptographyUnitTests {
    ...
    ProvateValidPrivateKeyCanSignTransaction() {
        var privateKey = "[Insert valid private key]";
    }
    ProvateValidPrivateKeyCanSignTransaction() {
        var privateKey = "[Insert valid private key]";
    ...
    //Test valid privateKey can sign a valid transactionHash and give the proper signature
    //Test two privateKeys dont generate the same signature for the same transactioin
    //Test two transactions dont generate the same signature for the same private key
    //Test invalid privateKey throws
    //Test invalid transactionHash throws
}
